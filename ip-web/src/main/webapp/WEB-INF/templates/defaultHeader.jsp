	...
	<div class="container-fluid">
		...
		<div id="mainMenuDiv" class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="/myapps/whatismyip">What is my ip?</a></li>
				<li class="dropdown active"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false">Expense Tracker <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li id="expenseListMenu"><a href="/myapps/expensetracker/expense.exp">Expense
								List</a></li>
	...
	<!-- <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Expense Tracker<span class="fa arrow"></span></a>
